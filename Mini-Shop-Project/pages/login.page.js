...
export class LoginPage {
  constructor(page) {
    ...
    this.signinBtn = page.getByRole('link', { name: 'Sign In to your account' }).first();
...
//Log In with Valid credentials and take screenshot
  async login() {
    await this.email.fill(creds.valid.email);
    await this.password.fill(creds.valid.password);
